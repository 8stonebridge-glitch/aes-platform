...
export async function deploymentHandler(state) {
    ...
    if (hasVercel && githubFullName) {
        try {
            ...
            const project = await vercel.createProject(appSlug, githubFullName, envVars);
            ...
            const result = await vercel.waitForProjectDeployment(project.id, 300000); // 5 min timeout
