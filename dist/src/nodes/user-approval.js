 ...
 */
export async function userApproval(state) {
    ...
    const approved = await cb?.onNeedsApproval("Review the app plan above and approve to proceed with building.", { appSpec: state.appSpec });
    if (approved) {
