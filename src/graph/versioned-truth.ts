 ...
 */
export function cypherCreateEntity(
  entity: EntityNode,
  firstVersion: Omit<VersionNode, "version_number" | "status" | "promoted_at">,
 ...
 */
export function cypherPromoteVersion(
  entityId: string,
  newVersion: {
    version_id: string;
    snapshot_name: string;
...
SET new_v.version_number = next_ver,
    ...
    new_v.snapshot_description = '${esc(newVersion.snapshot_description)}'${
      newVersion.snapshot_text
 ...
 */
export function cypherLinkEvidence(
  changeEventId: string,
  evidenceNodeName: string,
  evidenceLabel: string = "Decision"
): string {
  return `
 ...
 */
export function cypherResolveCurrentTruth(entityId: string): string {
  return `
MATCH (e:Entity {entity_id: '${entityId}'})
 ...
 */
export function cypherResolveBySystem(system: string): string {
  return `
 ...
 */
export function cypherGetVersionHistory(entityId: string): string {
  return `
MATCH (e:Entity {entity_id: '${entityId}'})
 ...
 */
export function cypherGetVersion(entityId: string, versionNumber: number): string {
  return `
MATCH (e:Entity {entity_id: '${entityId}'})
 ...
 */
export function cypherDiffVersions(entityId: string, fromVer: number, toVer: number): string {
  return `
MATCH (e:Entity {entity_id: '${entityId}'})
 ...
 */
export const INVARIANT_CHECKS: { name: string; cypher: string; expect: string }[] = [
  {
 ...
 */
export function cypherRunAllInvariants(): string {
  return INVARIANT_CHECKS.map(check =>
