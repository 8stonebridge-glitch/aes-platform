...
async function main() {
  ...
  f1.forEach((r: any) => console.log("  ", r.name, "|", (r.desc || "").slice(0, 80)));
  ...
  f2.forEach((r: any) => console.log("  ", r.name, "|", (r.desc || "").slice(0, 80)));
  ...
  m.forEach((r: any) => console.log("  ", r.name, "("+r.cat+")"));
  ...
  i.forEach((r: any) => console.log("  ", r.name, "|", r.type));
  ...
  `);
  stats.forEach((r: any) => console.log("  ", r.label, ":", r.cnt));
