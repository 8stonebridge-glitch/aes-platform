...
async function main() {
  ...
  console.log(`  Rules:`);
  rules.forEach((r: any) => console.log(`    ${r.id}: ${r.title}`));
  console.log(`\n  Strategies:`);
  strats.forEach((r: any) => console.log(`    ${r.id}: ${r.title}`));
  console.log(`\n  Pre-flight:`);
  checks.forEach((r: any) => console.log(`    ${r.id}: ${r.title}`));
  console.log(`\n  Lessons:`);
  lessons.forEach((r: any) => console.log(`    ${r.id}: ${r.title}`));
