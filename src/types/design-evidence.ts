...
export interface NavEdge {
  ...
  to_screen_id: string;
  trigger: string; // "click nav item", "submit form", "click row", etc.
  label?: string;
}
...
export type DataViewCapability =
  | "sort"
  | "filter"
  | "search"
  | "pagination"
...
export interface LayoutInfo {
  ...
  sidebar?: { position: "left" | "right"; collapsible: boolean; width_hint: string };
  /** Topbar details if present */
  topbar?: { sticky: boolean; has_search: boolean; has_user_menu: boolean; has_notifications: boolean };
  /** Content area details */
  content?: { max_width?: string; padding?: string };
}
...
// ═══════════════════════════════════════════════════════════════
// BRIDGE DESIGN CONSTRAINTS (added to FeatureBridge)
// ═══════════════════════════════════════════════════════════════

export interface DesignConstraints {
  /** Required screens for this feature */
  required_screens: { screen_id: string; name: string; purpose: string }[];
  /** Required components */
  required_components: { component_id: string; name: string; category: string }[];
  /** Required data views */
  required_data_views: { view_id: string; name: string; type: string; columns: string[]; capabilities: string[] }[];
  /** Required forms */
  required_forms: { form_id: string; name: string; fields: string[] }[];
  /** Required actions */
  required_actions: { action_id: string; label: string; type: string; is_destructive: boolean }[];
  /** Required states */
  required_states: { state_id: string; type: string; screen_id: string }[];
  /** Required navigation entries */
  required_nav: { label: string; target_screen_id: string; level: string }[];
}

// ═══════════════════════════════════════════════════════════════
// VALIDATION RESULT (from design-verify.ts)
// ═══════════════════════════════════════════════════════════════
